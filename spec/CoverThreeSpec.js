...
describe("page", function() {
    ...
    it("starts with first player turn", function() {
        expect(c3.board.getCurrentPlayer(c3.state.get()).id).toBe(c3.player1);
    });
...
describe("board", function() {
    ...
    it("can set square", function() {
        c3.board.setSquarePiece(0, help.getPlayer1SmallPiece(),c3.state);
        expect(help.boardSquareHasPiece(0, help.getPlayer1SmallPiece())).toBeTruthy();
    });
    it("can be restored", function() {
        c3.board.setSquarePiece(0, help.getPlayer1SmallPiece(),c3.state);
        var oldState = c3.state.get();
        c3.board.setSquarePiece(0, help.getPlayer2LargePiece(),c3.state);
        c3.state.set(oldState);
        expect(help.boardSquareHasPiece(0, help.getPlayer1SmallPiece())).toBeTruthy();
    });
});
